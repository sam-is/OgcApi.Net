...
VALUES (geometry::STGeomFromText('POLYGON((0 0, 0 1000000, 1000000 1000000, 1000000 0, 0 0))', 3857), 'Simple polygon', 1, 0.25, '2020-01-01'),
	   ...
	   (geometry::STGeomFromText('MULTIPOLYGON(((0 2000000, 0 3000000, 1000000 3000000, 1000000 2000000, 0 2000000)), ((1250000 2250000, 1250000 2750000, 1750000 2750000, 1750000 2250000, 1250000 2250000)))', 3857), 'MiltiPolygon with two parts', 3, 12.25, '2022-01-01'),
	   (geometry::STGeomFromText('MULTIPOLYGON(((2000000 2000000, 2000000 3000000, 3000000 3000000, 3000000 2000000, 2000000 2000000), (2250000 2250000, 2250000 2750000, 2750000 2750000, 2750000 2250000, 2250000 2250000)), ((3250000 2250000, 3250000 2750000, 3750000 2750000, 3750000 2250000, 3250000 2250000)))', 3857), 'MiltiPolygon with two parts, one with hole', 4, 113, '2023-01-01')
...
CREATE TABLE [dbo].[EmptyTable] (
	...
	[Geom] [geometry] NULL,
	[Name] [nvarchar](255) NULL,
	CONSTRAINT [PK_EmptyTable] PRIMARY KEY CLUSTERED ([Id] ASC)
);
